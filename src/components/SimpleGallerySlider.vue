    ...
    <div ref="mainContainer" :style="'height:' + height + 'px'" class="main-container">
      <div class="arrows-container">
        ...
        <div @click="upperSlideLeft" class="arrow left-arrow">
          <img :style="'width:' + upperArrowSize" class="img-fluid arrow-icon arrow-icon-left" src="./img/arrow_left.svg" />
        </div>
        <div @click="upperSlideRight" class="arrow right-arrow">
          <img :style="'width:' + upperArrowSize" class="img-fluid arrow-icon arrow-icon-right" src="./img/arrow_right.svg" />
        </div>
      </div>
    ...
    <div ref="thumbContainer" :style="'height:' + thumbHeight + 'px'" class="thumb-container">
      <div class="arrows-container">
        ...
        <div @click="lowerSlideLeft" class="arrow left-arrow">
          <img :style="'width:' + lowerArrowSize" class="img-fluid arrow-icon arrow-icon-left" src="./img/arrow_left.svg" />
        </div>
        <div @click="lowerSlideRight" class="arrow right-arrow">
          <img :style="'width:' + lowerArrowSize" class="img-fluid arrow-icon arrow-icon-right" src="./img/arrow_right.svg" />
        </div>
      </div>
